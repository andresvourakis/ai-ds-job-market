...
with col2:
    ...
    st.metric("Jobs with AI Keywords", len(ai_jobs_df), f"{pct_ai:.1f}%")
...
with col3:
    ...
    st.metric("Jobs with AI Skills", len(ai_jobs_specific_df), f"{pct_ai_specific:.1f}%")
...
with col4:
    ...
    st.metric("Top AI Skill", top_ai_skill[0], f"in {top_ai_skill[1]} jobs")
